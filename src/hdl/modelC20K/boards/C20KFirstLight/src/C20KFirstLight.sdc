...
#create_generated_clock -name CLOCK_SOUND -source [get_nets {G_DO1BIT_DAC_VIDEO.e_chroma_gen/i_clk_chroma_x4}] -master_clock CLOCK_CHROMA -divide_by 5 -multiply_by 1 [get_nets {G_DO1BIT_DAC_VIDEO.clkdiv5/CLKOUT.default_gen_clk}]
