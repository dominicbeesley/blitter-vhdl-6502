...
create_generated_clock -name main_pll -source [get_ports {clk_27_i}] -master_clock brd_clk -divide_by 8 -multiply_by 22 [get_nets {i_clk_pll128}]
...
set_multicycle_path -from [get_regs {e_xylon/e_fb_cpu_t65only/e_burst/r_D_rd_*_s0}] -to [get_regs {e_xylon/e_fb_cpu_t65only/e_t65/e_cpu/BAL_*_s0}] -end  -setup 2
set_multicycle_path -from [get_regs {e_xylon/e_fb_cpu_t65only/e_burst/r_D_rd_*_s0}] -to [get_regs {e_xylon/e_fb_cpu_t65only/e_t65/e_cpu/BAL_*_s0}] -end  -hold 1
...
set_multicycle_path -from [get_pins {e_xylon/e_fb_cpu_t65only/e_burst/r_D_rd_0_s0/D}] -to [get_pins {e_xylon/e_fb_cpu_t65only/e_t65/e_cpu/BAL_4_s0/D}] -end  -setup 2
set_multicycle_path -from [get_pins {e_xylon/e_fb_cpu_t65only/e_burst/r_D_rd_0_s0/D}] -to [get_pins {e_xylon/e_fb_cpu_t65only/e_t65/e_cpu/BAL_4_s0/D}] -end  -hold 1
