...
set t65regs  [ get_pins {e_fb_cpu_t65only/e_t65/e_cpu*|*} ]

set_multicycle_path -setup -end -from  $t65regs  -to  $t65regs 4
set_multicycle_path -hold -end -from  $t65regs   -to  $t65regs 3
