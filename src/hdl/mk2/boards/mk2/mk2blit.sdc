...
#cpu multi-cycles
set t65paths [ get_pins {e_fb_cpu|e_t65|e_cpu|*|*} ]

set_multicycle_path -setup -end -from  $t65paths  -to  $t65paths 8
set_multicycle_path -hold -end -from  $t65paths   -to  $t65paths 7


#blitter addr calcs multi-cycles

set blitpaths [ get_pins {e_fb_blit|addr_gen|*|*} ]
