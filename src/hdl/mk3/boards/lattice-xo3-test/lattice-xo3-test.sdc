...
set_output_delay -clock [get_clocks {main_pll}] -max 2.000 [get_ports {MEM_A_o*}]
set_output_delay -clock [get_clocks {main_pll}] -max 2.000 [get_ports {MEM_D_io*}]
set_output_delay -clock [get_clocks {main_pll}] -max 2.000 [get_ports {MEM_nOE_o}]
set_output_delay -clock [get_clocks {main_pll}] -max 2.000 [get_ports {MEM_nWE_o}]
set_output_delay -clock [get_clocks {main_pll}] -max 2.000 [get_ports {MEM_FL_nCE_o}]
set_output_delay -clock [get_clocks {main_pll}] -max 2.000 [get_ports {MEM_RAM_nCE_o*}]
set_output_delay -clock [get_clocks {main_pll}] -min 0.000 [get_ports {MEM_A_o*}]
set_output_delay -clock [get_clocks {main_pll}] -min 0.000 [get_ports {MEM_D_io*}]
set_output_delay -clock [get_clocks {main_pll}] -min 0.000 [get_ports {MEM_nOE_o}]
set_output_delay -clock [get_clocks {main_pll}] -min 0.000 [get_ports {MEM_nWE_o}]
set_output_delay -clock [get_clocks {main_pll}] -min 0.000 [get_ports {MEM_FL_nCE_o}]
set_output_delay -clock [get_clocks {main_pll}] -min 0.000 [get_ports {MEM_RAM_nCE_o*}]
