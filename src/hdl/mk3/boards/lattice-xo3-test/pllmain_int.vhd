...
architecture Structure of pllmain_int is
    ...
    attribute FREQUENCY_PIN_CLKOS of PLLInst_0 : label is "3.539171";
    attribute FREQUENCY_PIN_CLKOP of PLLInst_0 : label is "128.000000";
...
begin
    ...
    PLLInst_0: EHXPLLJ
        ...
        PLL_USE_WB=> "DISABLED", CLKOS3_FPHASE=>  0, CLKOS3_CPHASE=>  6, 
        CLKOS2_FPHASE=>  0, CLKOS2_CPHASE=>  0, CLKOS_FPHASE=>  0, 
        CLKOS_CPHASE=>  30, CLKOP_FPHASE=>  0, CLKOP_CPHASE=>  5, 
        ...
        PREDIVIDER_MUXB1=>  2, VCO_BYPASS_B0=> "DISABLED", CLKOS_ENABLE=> "ENABLED", 
        OUTDIVIDER_MUXA2=> "DIVA", PREDIVIDER_MUXA1=>  0, VCO_BYPASS_A0=> "DISABLED", 
        CLKOP_ENABLE=> "ENABLED", CLKOS3_DIV=>  7, CLKOS2_DIV=>  1, 
        CLKOS_DIV=>  31, CLKOP_DIV=>  6, CLKFB_DIV=>  8, CLKI_DIV=>  3, 
        FEEDBK_PATH=> "CLKOP")
...
-- synopsys translate_off
library MACHXO3L;
configuration Structure_CON of pllmain_int is
    for Structure
