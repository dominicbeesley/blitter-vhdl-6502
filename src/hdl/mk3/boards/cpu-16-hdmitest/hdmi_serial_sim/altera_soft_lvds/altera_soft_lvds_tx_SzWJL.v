...
module  altera_soft_lvds_tx_SzWJL_ddio_out_0cd
	( 
	datain_h,
	datain_l,
	dataout,
...
endmodule //altera_soft_lvds_tx_SzWJL_ddio_out_0cd
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  altera_soft_lvds_tx_SzWJL_cmpr_jqb
	( 
	aeb,
	dataa,
...
endmodule //altera_soft_lvds_tx_SzWJL_cmpr_jqb
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  altera_soft_lvds_tx_SzWJL_cmpr_qge
	( 
	aeb,
	dataa,
	datab) /* synthesis synthesis_clearbox=1 */;
...
`endif
	...
	assign
		...
		data_wire = {datab[2], dataa[2], datab[1], dataa[1], datab[0], dataa[0], (data_wire[6] ^ data_wire[7]), ((data_wire[2] ^ data_wire[3]) | (data_wire[4] ^ data_wire[5]))},
		eq_wire = aeb_result_wire;
endmodule //altera_soft_lvds_tx_SzWJL_cmpr_qge

//synthesis_resources = lut 3 reg 3 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  altera_soft_lvds_tx_SzWJL_cntr_a5d
	( 
	clock,
	q,
...
`endif
	...
	altera_soft_lvds_tx_SzWJL_cmpr_qge   cmpr20
	( 
	.aeb(wire_cmpr20_aeb),
	.dataa(safe_q),
	.datab(modulus_bus));
	assign
		...
		updown_dir = updown;
endmodule //altera_soft_lvds_tx_SzWJL_cntr_a5d
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  altera_soft_lvds_tx_SzWJL_shift_reg_bod
	( 
	clock,
	data,
	load,
...
endmodule //altera_soft_lvds_tx_SzWJL_shift_reg_bod

//synthesis_resources = IO 4 lut 3 reg 63 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  altera_soft_lvds_tx_SzWJL
	( 
	tx_coreclock,
	tx_in,
	tx_inclock,
...
`endif
	...
	altera_soft_lvds_tx_SzWJL_ddio_out_0cd   ddio_out
	( 
	.datain_h(l_input),
	.datain_l(h_input),
	...
	altera_soft_lvds_tx_SzWJL_cmpr_jqb   cmpr10
	( 
	.aeb(wire_cmpr10_aeb),
	.dataa(dffe4a),
	.datab(dffe8a));
	altera_soft_lvds_tx_SzWJL_cmpr_jqb   cmpr9
	( 
	.aeb(wire_cmpr9_aeb),
	.dataa(dffe3a),
	.datab(dffe7a));
	altera_soft_lvds_tx_SzWJL_cntr_a5d   cntr2
	( 
	.clock(fast_clock),
	.q(wire_cntr2_q),
	.updown(sync_dffe1a));
	altera_soft_lvds_tx_SzWJL_shift_reg_bod   shift_reg12
	( 
	.clock(fast_clock),
	...
	altera_soft_lvds_tx_SzWJL_shift_reg_bod   shift_reg13
	( 
	.clock(fast_clock),
	...
	altera_soft_lvds_tx_SzWJL_shift_reg_bod   shift_reg14
	( 
	.clock(fast_clock),
	...
	altera_soft_lvds_tx_SzWJL_shift_reg_bod   shift_reg15
	( 
	.clock(fast_clock),
	...
	altera_soft_lvds_tx_SzWJL_shift_reg_bod   shift_reg16
	( 
	.clock(fast_clock),
	...
	altera_soft_lvds_tx_SzWJL_shift_reg_bod   shift_reg17
	( 
	.clock(fast_clock),
	...
	altera_soft_lvds_tx_SzWJL_shift_reg_bod   shift_reg18
	( 
	.clock(fast_clock),
	...
	altera_soft_lvds_tx_SzWJL_shift_reg_bod   shift_reg19
	( 
	.clock(fast_clock),
...
endmodule //altera_soft_lvds_tx_SzWJL
//VALID FILE
