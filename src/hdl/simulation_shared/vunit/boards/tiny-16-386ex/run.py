...
lib.add_source_file(root + "mk3/boards/cpu-16-tiny/board_config_pack.vhd")
lib.add_source_file(root + "mk3/boards/cpu-16-tiny/version.vhd")
lib.add_source_file(root + "mk3/boards/cpu-16-tiny/pllmain.vhd")
...
lib.add_source_file(root + "mk3/shared/fb_CPU_386ex_exp_pins.vhd")
lib.add_source_file(root + "shared/fb_CPU_386ex.vhd")
...
# Sim files
lib.add_source_file(root + "library/common.vhd")
lib.add_source_file(root + "library/simulation/zero_ohm.vhd")
lib.add_source_file(root + "library/simulation/rom_tb.vhd")
lib.add_source_file(root + "library/simulation/ram_tb.vhd")
lib.add_source_file(root + "library/3rdparty/i386/i80386.vhd")
lib.add_source_file(root + "library/simulation/real386ex_tb.vhd")
...
lib.add_source_file(root + "mk3/simulation/sim_tb/sim_386ex_tb.vhd")

tb = lib.test_bench("sim_386ex_tb")
tb.set_generic("G_MOSROMFILE","../../../../../../../sim_asm/test_asmx86/build/bootx86_testbench_mos.rom")
